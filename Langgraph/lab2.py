#=============================================================
# LAB 2 — Multi-Step Workflow: University Admission Processing
# =============================================================
...
class StudentState(TypedDict):
    name: str
    age: int
    marks: float          # Entrance exam marks (out of 100)
    student_id: str       # Generated by create_id node
    department: str       # Assigned by assign_department node
    scholarship: str      # Determined by check_scholarship node
    message: str          # Final welcome message
...
def create_id(state: StudentState) -> StudentState:
    """
    Node 1: Generate a unique student ID.
    Pattern: VIT-YEAR-RANDOM_NUMBER
    """
    year = datetime.datetime.now().year
    number = random.randint(1000, 9999)
    state["student_id"] = f"VIT-{year}-{number}"
...
def check_scholarship(state: StudentState) -> StudentState:
    ...
    console.print(f"[yellow]→ Scholarship: {state['scholarship']}[/yellow]")
    return state
...
# Linear chain: each node feeds into the next
...
# -------------------------------------------------------------
# STEP 4: Run with Multiple Students
# -------------------------------------------------------------
...
if __name__ == "__main__":
    students = [
        {"name": "Ananya", "age": 18, "marks": 97.0, "student_id": "", "department": "", "scholarship": "", "message": ""},
        {"name": "Ravi",   "age": 19, "marks": 82.5, "student_id": "", "department": "", "scholarship": "", "message": ""},
        {"name": "John",   "age": 18, "marks": 63.0, "student_id": "", "department": "", "scholarship": "", "message": ""},
        {"name": "Priya",  "age": 18, "marks": 55.0, "student_id": "", "department": "", "scholarship": "", "message": ""},
    ]
